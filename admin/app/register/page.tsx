      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Create your account to manage the platform
          </p>
        </div>
        ...
        <Card className="border-slate-200 shadow-sm">
          <CardHeader className="space-y-1">
            ...
            <CardDescription>
              Sign up using your Google account or credentials
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {/* Google Auth Button */}
            <Button variant="outline" className="w-full bg-white hover:bg-slate-50" type="button">
              {/* Using the same Google SVG from the login page */}
            ...
            <form className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="email" name="email" type="email" placeholder="admin@akripesa.com" required />
              </div>
              <div className="space-y-2">
